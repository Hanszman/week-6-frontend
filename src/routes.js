...
import { BrowserRouter, Switch, Route } from 'react-router-dom'; // Para configurar as rotas da aplicação com o React, é necessário instalar esta dependência: npm install react-router-dom
